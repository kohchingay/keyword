...
word_2 = st.text_input("Copy a 2nd form of the word you would like to count from the Greek text (mostly in lower case), \n\npaste it here **(otherwise input the "&" symbol here)** and hit the 'Enter' button:\n\n\n\n")

word_3 = st.text_input("Copy a 3rd form of the word you would like to count from the Greek text (mostly in lower case), \n\npaste it here **(otherwise input the "&" symbol here)** and hit the 'Enter' button:\n\n\n\n")

word_4 = st.text_input("Copy a 4th form of the word you would like to count from the Greek text (mostly in lower case), \n\npaste it here **(otherwise input the "&" symbol here)** and hit the 'Enter' button:\n\n\n\n")

word_5 = st.text_input("Copy a 5th form of the word you would like to count from the Greek text (mostly in lower case), \n\npaste it here **(otherwise input the "&" symbol here)** and hit the 'Enter' button:\n\n\n\n")

word_6 = st.text_input("Copy a 6th form of the word you would like to count from the Greek text (mostly in lower case), \n\npaste it here **(otherwise input the "&" symbol here)** and hit the 'Enter' button:\n\n\n\n")
